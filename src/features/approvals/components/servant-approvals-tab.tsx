...
export function ServantApprovalsTab({ onReview }: ServantApprovalsTabProps) {
  ...
  return (
    <SectionCard>
      ...
      {actionError ? (
        <div role="alert" className="mx-6 mt-4 rounded-xl border border-destructive/20 bg-destructive/10 px-4 py-3 text-sm text-destructive">
          {actionError}
        </div>
      ) : null}
